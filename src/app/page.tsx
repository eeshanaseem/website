    ...
    return (
        <main className="flex min-h-screen w-full flex-col items-center overflow-x-hidden overflow-y-scroll bg-gradient-to-br from-black via-slate-800 to bg-gray-800 justify-center sm:p-24">
            <div id="socials" className='w-[80%] sm:w-[600px] h-[20%] sm:h-[90px] bg-gradient-to-b from-slate-800/5 to-slate-800/95 rounded-2xl shadow-2xl flex items-center justify-evenly mb-9'>
                <a href="https://www.instagram.com/_eeshanaseem/" className='flex justify-center items-center h-[40px] w-[40px] rounded-full bg-opacity-[40%] bg-gray-500 my-4 shadow-2xl' target='_blank'>
                <Image
                    src={insta}
                    width={30}
                    height={30}
                ...
                <a href="https://github.com/eeshanaseem" className='flex justify-center items-center h-[40px] w-[40px] rounded-full bg-opacity-[40%] bg-gray-500 my-4 shadow-2xl' target='_blank'>
                <Image
                    src={github}
                    width={30}
                    height={30}
                ...
                <a href="https://twitter.com/EeshaNasym" className='flex justify-center items-center h-[40px] w-[40px] rounded-full bg-opacity-[40%] bg-gray-500 my-4 shadow-2xl' target='_blank'>
                <Image
                    src={x}
                    width={30}
                    height={30}
            ...
            <div id="container" className='p-4  w-[80%] sm:w-[600px] h-[80%] sm:h-[500px] bg-gradient-to-br from-black via-slate-800 to bg-gray-800 rounded-2xl shadow-2xl flex flex-col items-center justify-center'>
                ...
                <div id="intro" className='sm:px-5 sm:text-center'>
                    <p className='px-5 pt-6 text-orange-600/60'>I&apos;m an IBM student currently studying in Taylor&apos;s University.</p>
                </div>
            </div>
            <br />
